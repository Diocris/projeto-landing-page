    ...
    function firstSec() {
        ...
        for (const card of cards) {
            ...
            card.addEventListener("mouseleave", () => {
                ...
                cardName.innerText = "Pick your card"
                cardDetails.textContent = "Don't miss out on the exclusive benefits and rewards of our Star, Moon, and Sun Cards. Whether you're looking for cashback, travel perks, or premium services, we have the perfect card for you. Apply now and start enjoying the best of fee-free banking today!"
...
function openRegisterForm() {
   ...
   nextFake.addEventListener("click", ()=>{
    ...
    if(countClickFake === 0 && checkValue !== "gemini" || checkValue !== "gemeos" || checkValuen !== "gêmeos"){
        openSign.value = "" 
